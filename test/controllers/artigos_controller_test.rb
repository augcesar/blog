...
class ArtigosControllerTest < ActionController::TestCase
  ...
  test "should create artigo" do
    assert_difference('Artigo.count') do
      post :create, artigo: { data: @artigo.data, descricao: @artigo.descricao, publicar: @artigo.publicar, titulo: @artigo.titulo, usuario_id: @artigo.usuario_id }
    end
  ...
  test "should update artigo" do
    patch :update, id: @artigo, artigo: { data: @artigo.data, descricao: @artigo.descricao, publicar: @artigo.publicar, titulo: @artigo.titulo, usuario_id: @artigo.usuario_id }
    assert_redirected_to artigo_path(assigns(:artigo))
  end
