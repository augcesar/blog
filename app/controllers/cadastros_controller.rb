class CadastrosController < ApplicationController
  ...
  # POST /cadastros.json
  def create
    @cadastro = Usuario.new(cadastro_params)

    respond_to do |format|
      if @cadastro.save
        format.html { redirect_to cadastros_url, notice: 'Usuario was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @cadastro.update(cadastro_params)
        format.html { redirect_to cadastros_url, notice: 'Usuario was successfully updated.' }
  ...
  def destroy
    @cadastro.destroy
    respond_to do |format|
      format.html { redirect_to cadastros_url, notice: 'Usuario was successfully destroyed.' }
  ...
  private
    ...
    def set_cadastro
      @cadastro = Usuario.find(params[:id])
    end
